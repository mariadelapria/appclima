...
def analises_5dias_graficos(df):
    ...
    # Gradiente de fundo
    gradiente_bg = "linear-gradient(to bottom, #f69a50, #c46142, #795347, #335055, #0c161e)"
    ...
    fig1 = go.Figure(go.Indicator(
        ...
        gauge={'axis': {'range': [0, max(df['temp_max']) + 5]},
               'bar': {'color': "#ff914d"},  # laranja
               'bgcolor': "#0097b2",         # fundo do gauge
               'borderwidth': 3,
               'bordercolor': "#ff914d"}
    ))
    fig1.update_layout(
    ...
    fig3 = go.Figure(go.Bar(
        ...
        marker_color=["#ff914d", "#0097b2"],  # laranja e azul escuro
